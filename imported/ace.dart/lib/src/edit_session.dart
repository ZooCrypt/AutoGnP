...
abstract class EditSession extends _Disposable {
  ...
  // Adds a marker to the given [range] with class [clazz] of type [type]
  // which is in front if [inFront] is true.
  int addMarker(Range range, String clazz, String type, bool inFront);
