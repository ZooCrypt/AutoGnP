...
$$.Closure$1 = [Y, {"": "Closure;call$1,$name", $is_args1: true}];
...
edit: function(element) {
  return E._EditorProxy$_(J.$index$asx($.get$context(), "ace").callMethod$2("edit", [element]));
},

_loadModule: function(moduleType, modulePath) {
  var t1, completer;
  t1 = P.JsObject;
  completer = new P._AsyncCompleter(P._Future$(t1));
  H.setRuntimeTypeInfo(completer, [t1]);
  J.$index$asx(J.$index$asx($.get$context(), "ace"), "config").callMethod$2("loadModule", [P.JsObject_JsObject$jsify([moduleType, modulePath]), new E._loadModule_closure(completer)]);
  return completer.future;
},

Delta_Delta$_forProxy: function(proxy) {
  var t1, t2, t3;
  t1 = J.getInterceptor$asx(proxy);
  switch (t1.$index(proxy, "action")) {
    case "insertLines":
      t2 = t1.$index(proxy, "action");
      t3 = E.Range$_(t1.$index(proxy, "range"));
      t1 = t1.$index(proxy, "lines");
      return new E.InsertLinesDelta(C.C_JsonCodec.decode$1(J.$index$asx($.get$context(), "JSON").callMethod$2("stringify", [t1])), t2, t3);
    case "insertText":
      t2 = t1.$index(proxy, "action");
      t3 = E.Range$_(t1.$index(proxy, "range"));
      return new E.InsertTextDelta(t1.$index(proxy, "text"), t2, t3);
    case "removeLines":
      return E.RemoveLinesDelta$_fromProxy(proxy);
    case "removeText":
      t2 = t1.$index(proxy, "action");
      t3 = E.Range$_(t1.$index(proxy, "range"));
      return new E.RemoveTextDelta(t1.$index(proxy, "text"), t2, t3);
    default:
      throw H.wrapException(P.UnsupportedError$("Unknown action: " + H.S(t1.$index(proxy, "action"))));
  }
},

KeyboardHandler_KeyboardHandler$named: function($name) {
  var t1;
  if ($name == null) {
    t1 = new P._Future(0, $.Zone__current, null, null, null, null, null, null);
    t1.$builtinTypeInfo = [null];
    t1._asyncComplete$1(null);
    return new E._KeyboardHandlerProxy(null, null, t1);
  } else
    return E._KeyboardHandlerProxy$("ace/keyboard/" + H.S($name));
},

_loadModule_closure: {"": "Closure;completer_0",
  call$1: function(module) {
    var t1 = this.completer_0.future;
    if (t1._state !== 0)
      H.throwExpression(new P.StateError("Future already completed"));
    t1._asyncComplete$1(module);
    return;
  },
  "+call:1:0": 0,
  $isFunction: true,
...
_HasProxy: {"": "_Disposable;",
  ...
  "+call:1:0": 0,
  _ace$_HasProxy$async$1: function(proxyFuture) {
    proxyFuture.then$1(new E._HasProxy$async_closure(this));
  },
  $isFunction: true,
  $is_args2: true,
  $is_args1: true
...
_HasProxy$async_closure: {"": "Closure;this_0",
  call$1: function(proxy) {
    this.this_0._proxy = proxy;
    return proxy;
  },
  "+call:1:0": 0,
  $isFunction: true,
...
InsertLinesDelta: {"": "Delta;lines,action,range"},

InsertTextDelta: {"": "Delta;text,action,range"},

RemoveLinesDelta: {"": "Delta;lines,nl,action,range", static: {
RemoveLinesDelta$_fromProxy: function(proxy) {
  var t1, t2, t3, t4;
  t1 = J.getInterceptor$asx(proxy);
  t2 = t1.$index(proxy, "action");
  t3 = E.Range$_(t1.$index(proxy, "range"));
  t4 = t1.$index(proxy, "lines");
  return new E.RemoveLinesDelta(C.C_JsonCodec.decode$1(J.$index$asx($.get$context(), "JSON").callMethod$2("stringify", [t4])), t1.$index(proxy, "nl"), t2, t3);
}}
},

RemoveTextDelta: {"": "Delta;text,action,range"},

EditSessionChangeEvent: {"": "Object;oldSession,newSession"},

Point: {"": "Object;row,column",
  $eq: function(_, other) {
    var t1;
    if (other == null)
      return false;
  ...
  get$hashCode: function(_) {
    return (J.get$hashCode$(this.row) ^ J.get$hashCode$(this.column)) >>> 0;
  },
  toString$0: function(_) {
...
_DocumentProxy: {"": "_HasProxy;_onChange,_proxy,_onHasProxy",
  get$length: function(_) {
    return this._proxy.callMethod$2("getLength", null);
  },
  _ace$_DocumentProxy$_$1: function(proxy) {
    this._proxy.callMethod$2("on", ["change", new E._DocumentProxy$__closure(this)]);
  },
  static: {
_DocumentProxy$_: function(proxy) {
  var t1 = new E._DocumentProxy(P.StreamController_StreamController$broadcast(null, null, false, E.Delta), proxy, P._Future$immediate(null, null));
  t1._ace$_DocumentProxy$_$1(proxy);
  return t1;
}}

},

_DocumentProxy$__closure: {"": "Closure;this_0",
  call$2: function(e, __) {
    var t1, t2;
    t1 = this.this_0._onChange;
    t2 = E.Delta_Delta$_forProxy(J.$index$asx(e, "data"));
    if (t1._state >= 4)
...
_EditSessionProxy: {"": "_HasProxy;_onChange,_onChangeBreakpoint,_onChangeOverwrite,_onChangeScrollLeft,_onChangeScrollTop,_onChangeTabSize,_onChangeWrapLimit,_onChangeWrapMode,_proxy,_onHasProxy",
  get$length: function(_) {
    return this._proxy.callMethod$2("getLength", null);
  },
  toString$0: function(_) {
  ...
  _ace$_EditSessionProxy$_$1: function(proxy) {
    this._proxy.callMethod$2("on", ["change", new E._EditSessionProxy$__closure(this)]);
    this._proxy.callMethod$2("on", ["changeBreakpoint", new E._EditSessionProxy$__closure0(this)]);
    this._proxy.callMethod$2("on", ["changeOverwrite", new E._EditSessionProxy$__closure1(this)]);
    this._proxy.callMethod$2("on", ["changeScrollLeft", new E._EditSessionProxy$__closure2(this)]);
    this._proxy.callMethod$2("on", ["changeScrollTop", new E._EditSessionProxy$__closure3(this)]);
    this._proxy.callMethod$2("on", ["changeTabSize", new E._EditSessionProxy$__closure4(this)]);
    this._proxy.callMethod$2("on", ["changeWrapLimit", new E._EditSessionProxy$__closure5(this)]);
    this._proxy.callMethod$2("on", ["changeWrapMode", new E._EditSessionProxy$__closure6(this)]);
  },
  static: {
_EditSessionProxy$_: function(proxy) {
  var t1 = new E._EditSessionProxy(P.StreamController_StreamController$broadcast(null, null, false, E.Delta), P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, J.JSInt), P.StreamController_StreamController$broadcast(null, null, false, J.JSInt), P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, null), proxy, P._Future$immediate(null, null));
  t1._ace$_EditSessionProxy$_$1(proxy);
  return t1;
}}

},

_EditSessionProxy$__closure: {"": "Closure;this_0",
  call$2: function(e, __) {
    var t1, t2;
    t1 = this.this_0._onChange;
    t2 = E.Delta_Delta$_forProxy(J.$index$asx(e, "data"));
...
_EditSessionProxy$__closure0: {"": "Closure;this_1",
  call$2: function(_, __) {
    var t1, t2;
    t1 = this.this_1;
    t2 = t1._onChangeBreakpoint;
    if (t2._state >= 4)
...
_EditSessionProxy$__closure1: {"": "Closure;this_2",
  call$2: function(_, __) {
    var t1, t2;
    t1 = this.this_2;
    t2 = t1._onChangeOverwrite;
    if (t2._state >= 4)
      H.throwExpression(t2._addEventError$0());
    t2._sendData$1(t1);
    return;
...
_EditSessionProxy$__closure2: {"": "Closure;this_3",
  call$2: function(e, __) {
    var t1, t2;
    t1 = this.this_3._onChangeScrollLeft;
    t2 = J.toInt$0$n(e);
    if (t1._state >= 4)
      H.throwExpression(t1._addEventError$0());
    t1._sendData$1(t2);
...
_EditSessionProxy$__closure3: {"": "Closure;this_4",
  call$2: function(e, __) {
    var t1, t2;
    t1 = this.this_4._onChangeScrollTop;
    t2 = J.toInt$0$n(e);
    if (t1._state >= 4)
      H.throwExpression(t1._addEventError$0());
    t1._sendData$1(t2);
...
_EditSessionProxy$__closure4: {"": "Closure;this_5",
  call$2: function(_, __) {
    var t1, t2;
    t1 = this.this_5;
    t2 = t1._onChangeTabSize;
    if (t2._state >= 4)
      H.throwExpression(t2._addEventError$0());
    t2._sendData$1(t1);
    return;
...
_EditSessionProxy$__closure5: {"": "Closure;this_6",
  call$2: function(_, __) {
    var t1, t2;
    t1 = this.this_6;
    t2 = t1._onChangeWrapLimit;
    if (t2._state >= 4)
      H.throwExpression(t2._addEventError$0());
    t2._sendData$1(t1);
    return;
...
_EditSessionProxy$__closure6: {"": "Closure;this_7",
  call$2: function(_, __) {
    var t1, t2;
    t1 = this.this_7;
    t2 = t1._onChangeWrapMode;
    if (t2._state >= 4)
      H.throwExpression(t2._addEventError$0());
    t2._sendData$1(t1);
    return;
...
_EditorProxy: {"": "_HasProxy;_onBlur,_onChange,_onChangeSession,_onCopy,_onFocus,_onPaste,_proxy,_onHasProxy",
  ...
  _ace$_EditorProxy$_$1: function(proxy) {
    this._proxy.callMethod$2("on", ["blur", new E._EditorProxy$__closure(this)]);
    this._proxy.callMethod$2("on", ["change", new E._EditorProxy$__closure0(this)]);
    this._proxy.callMethod$2("on", ["changeSession", new E._EditorProxy$__closure1(this)]);
    this._proxy.callMethod$2("on", ["copy", new E._EditorProxy$__closure2(this)]);
    this._proxy.callMethod$2("on", ["focus", new E._EditorProxy$__closure3(this)]);
    this._proxy.callMethod$2("on", ["paste", new E._EditorProxy$__closure4(this)]);
  },
  static: {
_EditorProxy$_: function(proxy) {
  var t1 = new E._EditorProxy(P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, E.Delta), P.StreamController_StreamController$broadcast(null, null, false, E.EditSessionChangeEvent), P.StreamController_StreamController$broadcast(null, null, false, J.JSString), P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, J.JSString), proxy, P._Future$immediate(null, null));
  t1._ace$_EditorProxy$_$1(proxy);
  return t1;
}}

},

_EditorProxy$__closure: {"": "Closure;this_0",
  call$2: function(_, __) {
    var t1, t2;
    t1 = this.this_0;
    t2 = t1._onBlur;
...
_EditorProxy$__closure0: {"": "Closure;this_1",
  call$2: function(e, __) {
    var t1, t2;
    t1 = this.this_1._onChange;
    t2 = E.Delta_Delta$_forProxy(J.$index$asx(e, "data"));
    if (t1._state >= 4)
      H.throwExpression(t1._addEventError$0());
    t1._sendData$1(t2);
...
_EditorProxy$__closure1: {"": "Closure;this_2",
  call$2: function(e, __) {
    var t1, t2, t3;
    t1 = this.this_2._onChangeSession;
    t2 = J.getInterceptor$asx(e);
    t3 = E._EditSessionProxy$_(t2.$index(e, "oldSession"));
    t2 = E._EditSessionProxy$_(t2.$index(e, "session"));
    if (t1._state >= 4)
      H.throwExpression(t1._addEventError$0());
    t1._sendData$1(new E.EditSessionChangeEvent(t3, t2));
  },
  "+call:2:0": 0,
  $isFunction: true,
  $is_args2: true
...
_EditorProxy$__closure2: {"": "Closure;this_3",
  call$2: function(e, __) {
    var t1 = this.this_3._onCopy;
    if (t1._state >= 4)
      H.throwExpression(t1._addEventError$0());
    t1._sendData$1(e);
    return;
...
_EditorProxy$__closure3: {"": "Closure;this_4",
  call$2: function(_, __) {
    var t1, t2;
    t1 = this.this_4;
    t2 = t1._onFocus;
...
_EditorProxy$__closure4: {"": "Closure;this_5",
  call$2: function(e, __) {
    var t1 = this.this_5._onPaste;
    if (t1._state >= 4)
      H.throwExpression(t1._addEventError$0());
    t1._sendData$1(e);
    return;
...
_KeyBindingProxy: {"": "_HasProxy;_proxy,_onHasProxy",
  set$keyboardHandler: function(handler) {
    handler._onHasProxy.then$1(new E._KeyBindingProxy_keyboardHandler_closure(this, handler));
  }
},

_KeyBindingProxy_keyboardHandler_closure: {"": "Closure;this_0,handler_1",
  call$1: function(_) {
    var t1 = this.handler_1._proxy;
    this.this_0._proxy.callMethod$2("setKeyboardHandler", [t1]);
  },
  "+call:1:0": 0,
  $isFunction: true,
  $is_args1: true
...
_KeyboardHandlerProxy: {"": "_HasProxy;path,_proxy,_onHasProxy", static: {
_KeyboardHandlerProxy$: function(path) {
  var t1, t2;
  t1 = E._loadModule("keybinding", path).then$1(new E._KeyboardHandlerProxy_closure());
  t2 = new E._KeyboardHandlerProxy(path, null, t1);
  t2._ace$_HasProxy$async$1(t1);
  return t2;
}}
},

_KeyboardHandlerProxy_closure: {"": "Closure;",
  call$1: function(module) {
    return P._Future$immediate(J.$index$asx(module, "handler"), null);
  },
  "+call:1:0": 0,
  $isFunction: true,
  $is_args1: true
...
_ThemeProxy: {"": "_HasProxy;path,_proxy,_onHasProxy"},
...
Range: {"": "Object;start,end",
  $eq: function(_, other) {
    ...
    if (this === other)
      return true;
    t1 = J.getInterceptor(other);
    if (typeof other !== "object" || other === null || !t1.$isRange)
      return false;
    t1 = this.start;
    if (t1.$eq(t1, other.start)) {
      t1 = this.end;
      t1 = t1.$eq(t1, other.end);
    } else
      t1 = false;
    return t1;
  },
  get$hashCode: function(_) {
    ...
    t1 = this.start;
    t2 = this.end;
    return (J.get$hashCode$(t1.row) ^ J.get$hashCode$(t1.column) ^ J.get$hashCode$(t2.row) ^ J.get$hashCode$(t2.column)) >>> 0;
  },
  _toProxy$0: function() {
    var t1, t2;
    t1 = this.start;
    t2 = this.end;
    return P.JsObject_JsObject(J.$index$asx(J.$index$asx(J.$index$asx(J.$index$asx(J.$index$asx($.get$context(), "ace"), "define"), "modules"), "ace/range"), C.Type_er0), [t1.row, t1.column, t2.row, t2.column]);
  },
  toString$0: function(_) {
    var t1, t2;
    t1 = this.start;
    t2 = this.end;
    return "Range: [" + H.S(t1.row) + "/" + H.S(t1.column) + "] -> [" + H.S(t2.row) + "/" + H.S(t2.column) + "]";
  },
  $isRange: true,
  static: {
Range$_: function(proxy) {
  var t1 = J.getInterceptor$asx(proxy);
  return new E.Range(new E.Point(J.$index$asx(t1.$index(proxy, "start"), "row"), J.$index$asx(t1.$index(proxy, "start"), "column")), new E.Point(J.$index$asx(t1.$index(proxy, "end"), "row"), J.$index$asx(t1.$index(proxy, "end"), "column")));
}}

}}],
["ace.example.keybindings", "zoocrypt-gui.dart", , Y, {
main: function() {
  var t1, t2, t3, $name;
  $.webSocket = W.WebSocket_WebSocket("ws://127.0.0.1:9999/", null);
  t1 = E.edit(document.querySelector("#editor-proof"));
  t2 = E._loadModule("theme", "ace/theme/xcode");
  t3 = new E._ThemeProxy("ace/theme/xcode", null, t2);
  t3._ace$_HasProxy$async$1(t2);
  t1.set$theme(t3);
  $.editorProof = t1;
  t1 = E.edit(document.querySelector("#editor-goal"));
  t1._proxy.callMethod$2("setReadOnly", [true]);
  t3 = E._loadModule("theme", "ace/theme/xcode");
  t2 = new E._ThemeProxy("ace/theme/xcode", null, t3);
  t2._ace$_HasProxy$async$1(t3);
  t1.set$theme(t2);
  $.editorGoal = t1;
  Y.createCommandButtons();
  for (t1 = new H.ListIterator(C.List_null_emacs_vim, 3, 0, null); t1.moveNext$0();) {
    $name = t1._current;
    t2 = E.KeyboardHandler_KeyboardHandler$named($name);
    Y._createButton(t2, $name == null ? "Ace default" : $name);
  }
  t1 = new W._EventStream(window, C.EventStreamProvider_keydown._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.main_closure()), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
},

sendZooCrypt: function(m) {
  var s = C.C_JsonCodec.encode$1(m);
  $.webSocket.send(s);
},

highlightLocked: function() {
  var t1, t2, cpos;
  t1 = E._DocumentProxy$_(E._EditSessionProxy$_($.editorProof._proxy.callMethod$2("getSession", null))._proxy.callMethod$2("getDocument", null));
  t2 = $.processedUpto;
  t2 = t1._proxy.callMethod$2("indexToPosition", [t2, 0]);
  t1 = J.getInterceptor$asx(t2);
  cpos = new E.Point(t1.$index(t2, "row"), t1.$index(t2, "column"));
  if ($.lastMarker != null) {
    t1 = E._EditSessionProxy$_($.editorProof._proxy.callMethod$2("getSession", null));
    t2 = $.lastMarker;
    t1._proxy.callMethod$2("removeMarker", [t2]);
  }
  t1 = E._EditSessionProxy$_($.editorProof._proxy.callMethod$2("getSession", null));
  t2 = new E.Range(new E.Point(0, 0), new E.Point(cpos.row, cpos.column))._toProxy$0();
  $.lastMarker = J.toInt$0$n(t1._proxy.callMethod$2("addMarker", [t2, "warning", "text", false]));
},

nextCommand: function(_) {
  var i, t1, t2, cpos;
  i = J.indexOf$2$asx($.editorProof._proxy.callMethod$2("getValue", null), ".", $.processedUpto);
  t1 = J.getInterceptor(i);
  if (!t1.$eq(i, -1)) {
    $.processedUpto = t1.$add(i, 1);
    P.print("Next: " + H.S($.processedUpto));
    t1 = E._DocumentProxy$_(E._EditSessionProxy$_($.editorProof._proxy.callMethod$2("getSession", null))._proxy.callMethod$2("getDocument", null));
    t2 = $.processedUpto;
    t2 = t1._proxy.callMethod$2("indexToPosition", [t2, 0]);
    t1 = J.getInterceptor$asx(t2);
    cpos = new E.Point(t1.$index(t2, "row"), t1.$index(t2, "column"));
    $.editorProof._proxy.callMethod$2("navigateTo", [cpos.row, cpos.column]);
  } else
    P.print("Next: no next command");
  Y.sendZooCrypt(H.fillLiteralMap(["cmd", "eval", "arg", J.substring$2$s($.editorProof._proxy.callMethod$2("getValue", null), 0, $.processedUpto)], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
  Y.highlightLocked();
},

prevCommand: function(_) {
  var i, t1, t2, cpos;
  i = J.lastIndexOf$2$asx($.editorProof._proxy.callMethod$2("getValue", null), ".", P.max(J.$sub$n($.processedUpto, 2), 0));
  t1 = J.getInterceptor(i);
  if (!t1.$eq(i, -1))
    $.processedUpto = t1.$add(i, 1);
  else {
    P.print("Previous: setting to 0.");
    $.processedUpto = 0;
  }
  P.print("Previous: " + H.S($.processedUpto));
  t1 = E._DocumentProxy$_(E._EditSessionProxy$_($.editorProof._proxy.callMethod$2("getSession", null))._proxy.callMethod$2("getDocument", null));
  t2 = $.processedUpto;
  t2 = t1._proxy.callMethod$2("indexToPosition", [t2, 0]);
  t1 = J.getInterceptor$asx(t2);
...
createCommandButtons: function() {
  var prevButton, t1, t2, t3, nextButton, loadButton, saveButton;
  prevButton = document.createElement("button", null);
  prevButton.textContent = "Previous";
  prevButton.toString;
  t1 = C.EventStreamProvider_click._eventType;
  t2 = new W._ElementEventStreamImpl(prevButton, t1, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(Y.prevCommand$closure), t2._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t3._tryResume$0();
  t3 = J.get$children$x(document.querySelector("#buttons-commands"));
  t3.add$1(t3, prevButton);
  nextButton = document.createElement("button", null);
  nextButton.textContent = "Next";
  nextButton.toString;
  t3 = new W._ElementEventStreamImpl(nextButton, t1, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t2 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(Y.nextCommand$closure), t3._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = J.get$children$x(document.querySelector("#buttons-commands"));
  t2.add$1(t2, nextButton);
  loadButton = document.createElement("button", null);
  loadButton.textContent = "Load";
  loadButton.toString;
  t2 = new W._ElementEventStreamImpl(loadButton, t1, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Y.createCommandButtons_closure()), t2._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t3._tryResume$0();
  t3 = J.get$children$x(document.querySelector("#buttons-commands"));
  t3.add$1(t3, loadButton);
  saveButton = document.createElement("button", null);
  saveButton.textContent = "Save";
  saveButton.toString;
  t1 = new W._ElementEventStreamImpl(saveButton, t1, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.createCommandButtons_closure0()), t1._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t3._tryResume$0();
  t3 = J.get$children$x(document.querySelector("#buttons-commands"));
  t3.add$1(t3, saveButton);
  t3 = $.webSocket;
  t3.toString;
  t3 = new W._EventStream(t3, C.EventStreamProvider_message._eventType, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t1 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new Y.createCommandButtons_closure1()), t3._useCapture);
  ...
  H.setRuntimeTypeInfo(t1, [null]);
  t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.createCommandButtons_closure2()), t1._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t3._tryResume$0();
},

_createButton: function(handler, $name) {
  var $parent, button, t1, $arguments, t2;
  $parent = document.querySelector("#buttons-bindings");
  button = document.createElement("button", null);
  button.textContent = $name;
  button.toString;
  t1 = new W._ElementEventStreamImpl(button, C.EventStreamProvider_click._eventType, false);
  t1.$builtinTypeInfo = [null];
  $arguments = H.substitute(t1.$as_EventStream, H.getRuntimeTypeInfo(t1));
  t2 = $arguments == null ? null : $arguments[0];
  t1 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y._createButton_closure(handler, $name)), t1._useCapture);
...
main_closure: {"": "Closure;",
  call$1: function(ev) {
    var kev, t1;
    kev = W.KeyEvent$wrap(ev);
    if (J.get$ctrlKey$x(kev._parent) === true) {
      t1 = kev._shadowKeyCode;
      if (t1 === 13) {
        P.print(J.toString$0(ev));
        Y.nextCommand(null);
      } else if (t1 === 8)
        Y.prevCommand(null);
    }
...
createCommandButtons_closure: {"": "Closure;",
  call$1: function(_) {
    Y.sendZooCrypt(H.fillLiteralMap(["cmd", "load", "arg", ""], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
  },
  "+call:1:0": 0,
  $isFunction: true,
  $is_args1: true
...
createCommandButtons_closure0: {"": "Closure;",
  call$1: function(_) {
    Y.sendZooCrypt(H.fillLiteralMap(["cmd", "save", "arg", $.editorProof._proxy.callMethod$2("getValue", null)], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
  },
  "+call:1:0": 0,
  $isFunction: true,
  $is_args1: true
...
createCommandButtons_closure1: {"": "Closure;",
  call$1: function(e) {
    var t1, reply;
    t1 = J.getInterceptor$x(e);
    P.print("Received: ``" + H.S(t1.get$data(e)) + "''");
    reply = C.C_JsonCodec.decode$1(t1.get$data(e));
    t1 = J.getInterceptor$asx(reply);
    if (J.$eq(t1.$index(reply, "cmd"), "setGoal")) {
      $.editorGoal.setValue$1(t1.$index(reply, "arg"));
      $.editorGoal._proxy.callMethod$2("clearSelection", null);
    } else if (J.$eq(t1.$index(reply, "cmd"), "setProof")) {
      P.print("setProof\n");
      $.editorProof.setValue$1(t1.$index(reply, "arg"));
      $.editorProof._proxy.callMethod$2("clearSelection", null);
    } else
      P.print("Reply ignored");
  },
  "+call:1:0": 0,
  $isFunction: true,
  $is_args1: true
...
createCommandButtons_closure2: {"": "Closure;",
  call$1: function(_) {
    Y.sendZooCrypt(H.fillLiteralMap(["cmd", "load", "arg", ""], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
  },
  "+call:1:0": 0,
...
_createButton_closure: {"": "Closure;handler_0,name_1",
  call$1: function(_) {
    new E._KeyBindingProxy(J.$index$asx($.editorProof._proxy, "keyBinding"), P._Future$immediate(null, null)).set$keyboardHandler(this.handler_0);
    document.querySelector("#label-bindings").textContent = this.name_1;
  },
  "+call:1:0": 0,
  $isFunction: true,
  $is_args1: true
...
IterableMixinWorkaround_lastIndexOfList: function(list, element, start) {
  return H.Arrays_lastIndexOf(list, element, start);
},
...
_IdentityHashMap: {"": "_HashMap;_length,_strings,_nums,_rest,_keys",
  _computeHashCode$1: function(key) {
...
InputElement: {"": "HtmlElement;", $isElement: true, $isNode: true, $isEventTarget: true, "%": "HTMLInputElement"},

KeyboardEvent: {"": "UIEvent;ctrlKey=", "%": "KeyboardEvent"},
...
MouseEvent: {"": "UIEvent;ctrlKey=", "%": "DragEvent|MSPointerEvent|MouseEvent|MouseScrollEvent|MouseWheelEvent|PointerEvent|WheelEvent"},
...
ObjectElement: {"": "HtmlElement;data=", "%": "HTMLObjectElement"},
...
UIEvent: {"": "Event;", "%": "FocusEvent|SVGZoomEvent;UIEvent"},
...
KeyEvent: {"": "_WrappedEvent;_parent,_shadowAltKey,_shadowCharCode,_shadowKeyCode,_currentTarget,wrapped",
  get$currentTarget: function(_) {
  ...
  KeyEvent$wrap$1: function($parent) {
    this._parent = $parent;
    this._shadowAltKey = this._parent.altKey;
    this._shadowCharCode = this._parent.charCode;
    this._shadowKeyCode = this._parent.keyCode;
    this._currentTarget = J.get$currentTarget$x(this._parent);
  },
  $isEvent: true,
  static: {
"": "KeyEvent__keyboardEventDispatchRecord,KeyEvent_keyDownEvent,KeyEvent_keyUpEvent,KeyEvent_keyPressEvent",
KeyEvent$wrap: function($parent) {
  var t1 = new W.KeyEvent(null, null, null, null, null, $parent);
...
init.globalFunctions.nextCommand$closure = Y.nextCommand$closure = new Y.Closure$1(Y.nextCommand, "nextCommand$closure");
init.globalFunctions.prevCommand$closure = Y.prevCommand$closure = new Y.Closure$1(Y.prevCommand, "prevCommand$closure");
...
init.globalFunctions._nullDataHandler$closure = P._nullDataHandler$closure = new Y.Closure$1(P._nullDataHandler, "_nullDataHandler$closure");
...
init.globalFunctions._defaultHashCode$closure = P._defaultHashCode$closure = new Y.Closure$1(P._defaultHashCode, "_defaultHashCode$closure");
init.globalFunctions._defaultToEncodable$closure = P._defaultToEncodable$closure = new Y.Closure$1(P._defaultToEncodable, "_defaultToEncodable$closure");
init.globalFunctions.identical$closure = P.identical$closure = new H.Closure$2(P.identical, "identical$closure");
init.globalFunctions.identityHashCode$closure = P.identityHashCode$closure = new Y.Closure$1(P.identityHashCode, "identityHashCode$closure");
...
init.globalFunctions._convertToJS$closure = P._convertToJS$closure = new Y.Closure$1(P._convertToJS, "_convertToJS$closure");
init.globalFunctions._convertToDart$closure = P._convertToDart$closure = new Y.Closure$1(P._convertToDart, "_convertToDart$closure");
...
C.List_null_emacs_vim = Isolate.makeConstantList([null, "emacs", "vim"]);
C.NodeList_methods = W.NodeList.prototype;
C.Symbol_call = new H.Symbol0("call");
C.Type_er0 = H.createRuntimeType('Range');
...
function dart_precompiled($collectedClasses) {
  ...
  function _loadModule_closure(completer_0) {
    this.completer_0 = completer_0;
  }
  _loadModule_closure.builtin$cls = "_loadModule_closure";
  if (!"name" in _loadModule_closure)
    _loadModule_closure.name = "_loadModule_closure";
  $desc = $collectedClasses._loadModule_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _loadModule_closure.prototype = $desc;
  function _Disposable() {
  }
  _Disposable.builtin$cls = "_Disposable";
  if (!"name" in _Disposable)
    _Disposable.name = "_Disposable";
  $desc = $collectedClasses._Disposable;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _Disposable.prototype = $desc;
  function _HasProxy() {
  }
  _HasProxy.builtin$cls = "_HasProxy";
  if (!"name" in _HasProxy)
    _HasProxy.name = "_HasProxy";
  $desc = $collectedClasses._HasProxy;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _HasProxy.prototype = $desc;
  function _HasProxy$async_closure(this_0) {
    this.this_0 = this_0;
  }
  _HasProxy$async_closure.builtin$cls = "_HasProxy$async_closure";
  if (!"name" in _HasProxy$async_closure)
    _HasProxy$async_closure.name = "_HasProxy$async_closure";
  $desc = $collectedClasses._HasProxy$async_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _HasProxy$async_closure.prototype = $desc;
  function Delta() {
  }
  Delta.builtin$cls = "Delta";
  if (!"name" in Delta)
    Delta.name = "Delta";
  $desc = $collectedClasses.Delta;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Delta.prototype = $desc;
  function InsertLinesDelta(lines, action, range) {
    this.lines = lines;
    this.action = action;
    this.range = range;
  }
  InsertLinesDelta.builtin$cls = "InsertLinesDelta";
  if (!"name" in InsertLinesDelta)
    InsertLinesDelta.name = "InsertLinesDelta";
  $desc = $collectedClasses.InsertLinesDelta;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InsertLinesDelta.prototype = $desc;
  function InsertTextDelta(text, action, range) {
    this.text = text;
    this.action = action;
    this.range = range;
  }
  InsertTextDelta.builtin$cls = "InsertTextDelta";
  if (!"name" in InsertTextDelta)
    InsertTextDelta.name = "InsertTextDelta";
  $desc = $collectedClasses.InsertTextDelta;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InsertTextDelta.prototype = $desc;
  function RemoveLinesDelta(lines, nl, action, range) {
    this.lines = lines;
    this.nl = nl;
    this.action = action;
    this.range = range;
  }
  RemoveLinesDelta.builtin$cls = "RemoveLinesDelta";
  if (!"name" in RemoveLinesDelta)
    RemoveLinesDelta.name = "RemoveLinesDelta";
  $desc = $collectedClasses.RemoveLinesDelta;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RemoveLinesDelta.prototype = $desc;
  function RemoveTextDelta(text, action, range) {
    this.text = text;
    this.action = action;
    this.range = range;
  }
  RemoveTextDelta.builtin$cls = "RemoveTextDelta";
  if (!"name" in RemoveTextDelta)
    RemoveTextDelta.name = "RemoveTextDelta";
  $desc = $collectedClasses.RemoveTextDelta;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RemoveTextDelta.prototype = $desc;
  function EditSessionChangeEvent(oldSession, newSession) {
    this.oldSession = oldSession;
    this.newSession = newSession;
  }
  EditSessionChangeEvent.builtin$cls = "EditSessionChangeEvent";
  if (!"name" in EditSessionChangeEvent)
    EditSessionChangeEvent.name = "EditSessionChangeEvent";
  $desc = $collectedClasses.EditSessionChangeEvent;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditSessionChangeEvent.prototype = $desc;
  ...
  function _DocumentProxy(_onChange, _proxy, _onHasProxy) {
    this._onChange = _onChange;
    this._proxy = _proxy;
    this._onHasProxy = _onHasProxy;
  }
  _DocumentProxy.builtin$cls = "_DocumentProxy";
  if (!"name" in _DocumentProxy)
    _DocumentProxy.name = "_DocumentProxy";
  $desc = $collectedClasses._DocumentProxy;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _DocumentProxy.prototype = $desc;
  function _DocumentProxy$__closure(this_0) {
    this.this_0 = this_0;
  }
  _DocumentProxy$__closure.builtin$cls = "_DocumentProxy$__closure";
  if (!"name" in _DocumentProxy$__closure)
    _DocumentProxy$__closure.name = "_DocumentProxy$__closure";
  $desc = $collectedClasses._DocumentProxy$__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _DocumentProxy$__closure.prototype = $desc;
  function _EditSessionProxy(_onChange, _onChangeBreakpoint, _onChangeOverwrite, _onChangeScrollLeft, _onChangeScrollTop, _onChangeTabSize, _onChangeWrapLimit, _onChangeWrapMode, _proxy, _onHasProxy) {
    this._onChange = _onChange;
  ...
  $desc = $collectedClasses._EditSessionProxy;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditSessionProxy.prototype = $desc;
  function _EditSessionProxy$__closure(this_0) {
    this.this_0 = this_0;
  }
  _EditSessionProxy$__closure.builtin$cls = "_EditSessionProxy$__closure";
  if (!"name" in _EditSessionProxy$__closure)
    _EditSessionProxy$__closure.name = "_EditSessionProxy$__closure";
  $desc = $collectedClasses._EditSessionProxy$__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditSessionProxy$__closure.prototype = $desc;
  function _EditSessionProxy$__closure0(this_1) {
    this.this_1 = this_1;
  }
  _EditSessionProxy$__closure0.builtin$cls = "_EditSessionProxy$__closure0";
  if (!"name" in _EditSessionProxy$__closure0)
    _EditSessionProxy$__closure0.name = "_EditSessionProxy$__closure0";
  $desc = $collectedClasses._EditSessionProxy$__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditSessionProxy$__closure0.prototype = $desc;
  function _EditSessionProxy$__closure1(this_2) {
    this.this_2 = this_2;
  }
  _EditSessionProxy$__closure1.builtin$cls = "_EditSessionProxy$__closure1";
  if (!"name" in _EditSessionProxy$__closure1)
    _EditSessionProxy$__closure1.name = "_EditSessionProxy$__closure1";
  $desc = $collectedClasses._EditSessionProxy$__closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditSessionProxy$__closure1.prototype = $desc;
  function _EditSessionProxy$__closure2(this_3) {
    this.this_3 = this_3;
  }
  _EditSessionProxy$__closure2.builtin$cls = "_EditSessionProxy$__closure2";
  if (!"name" in _EditSessionProxy$__closure2)
    _EditSessionProxy$__closure2.name = "_EditSessionProxy$__closure2";
  $desc = $collectedClasses._EditSessionProxy$__closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditSessionProxy$__closure2.prototype = $desc;
  function _EditSessionProxy$__closure3(this_4) {
    this.this_4 = this_4;
  }
  _EditSessionProxy$__closure3.builtin$cls = "_EditSessionProxy$__closure3";
  if (!"name" in _EditSessionProxy$__closure3)
    _EditSessionProxy$__closure3.name = "_EditSessionProxy$__closure3";
  $desc = $collectedClasses._EditSessionProxy$__closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditSessionProxy$__closure3.prototype = $desc;
  function _EditSessionProxy$__closure4(this_5) {
    this.this_5 = this_5;
  }
  _EditSessionProxy$__closure4.builtin$cls = "_EditSessionProxy$__closure4";
  if (!"name" in _EditSessionProxy$__closure4)
    _EditSessionProxy$__closure4.name = "_EditSessionProxy$__closure4";
  $desc = $collectedClasses._EditSessionProxy$__closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditSessionProxy$__closure4.prototype = $desc;
  function _EditSessionProxy$__closure5(this_6) {
    this.this_6 = this_6;
  }
  _EditSessionProxy$__closure5.builtin$cls = "_EditSessionProxy$__closure5";
  if (!"name" in _EditSessionProxy$__closure5)
    _EditSessionProxy$__closure5.name = "_EditSessionProxy$__closure5";
  $desc = $collectedClasses._EditSessionProxy$__closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditSessionProxy$__closure5.prototype = $desc;
  function _EditSessionProxy$__closure6(this_7) {
    this.this_7 = this_7;
  }
  _EditSessionProxy$__closure6.builtin$cls = "_EditSessionProxy$__closure6";
  if (!"name" in _EditSessionProxy$__closure6)
    _EditSessionProxy$__closure6.name = "_EditSessionProxy$__closure6";
  $desc = $collectedClasses._EditSessionProxy$__closure6;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditSessionProxy$__closure6.prototype = $desc;
  function _EditorProxy(_onBlur, _onChange, _onChangeSession, _onCopy, _onFocus, _onPaste, _proxy, _onHasProxy) {
  ...
  $desc = $collectedClasses._EditorProxy;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditorProxy.prototype = $desc;
  function _EditorProxy$__closure(this_0) {
    this.this_0 = this_0;
  }
  _EditorProxy$__closure.builtin$cls = "_EditorProxy$__closure";
  if (!"name" in _EditorProxy$__closure)
    _EditorProxy$__closure.name = "_EditorProxy$__closure";
  $desc = $collectedClasses._EditorProxy$__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditorProxy$__closure.prototype = $desc;
  function _EditorProxy$__closure0(this_1) {
    this.this_1 = this_1;
  }
  _EditorProxy$__closure0.builtin$cls = "_EditorProxy$__closure0";
  if (!"name" in _EditorProxy$__closure0)
    _EditorProxy$__closure0.name = "_EditorProxy$__closure0";
  $desc = $collectedClasses._EditorProxy$__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditorProxy$__closure0.prototype = $desc;
  function _EditorProxy$__closure1(this_2) {
    this.this_2 = this_2;
  }
  _EditorProxy$__closure1.builtin$cls = "_EditorProxy$__closure1";
  if (!"name" in _EditorProxy$__closure1)
    _EditorProxy$__closure1.name = "_EditorProxy$__closure1";
  $desc = $collectedClasses._EditorProxy$__closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditorProxy$__closure1.prototype = $desc;
  function _EditorProxy$__closure2(this_3) {
    this.this_3 = this_3;
  }
  _EditorProxy$__closure2.builtin$cls = "_EditorProxy$__closure2";
  if (!"name" in _EditorProxy$__closure2)
    _EditorProxy$__closure2.name = "_EditorProxy$__closure2";
  $desc = $collectedClasses._EditorProxy$__closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditorProxy$__closure2.prototype = $desc;
  function _EditorProxy$__closure3(this_4) {
    this.this_4 = this_4;
  }
  _EditorProxy$__closure3.builtin$cls = "_EditorProxy$__closure3";
  if (!"name" in _EditorProxy$__closure3)
    _EditorProxy$__closure3.name = "_EditorProxy$__closure3";
  $desc = $collectedClasses._EditorProxy$__closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditorProxy$__closure3.prototype = $desc;
  function _EditorProxy$__closure4(this_5) {
    this.this_5 = this_5;
  }
  _EditorProxy$__closure4.builtin$cls = "_EditorProxy$__closure4";
  if (!"name" in _EditorProxy$__closure4)
    _EditorProxy$__closure4.name = "_EditorProxy$__closure4";
  $desc = $collectedClasses._EditorProxy$__closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _EditorProxy$__closure4.prototype = $desc;
  function _KeyBindingProxy(_proxy, _onHasProxy) {
    this._proxy = _proxy;
    this._onHasProxy = _onHasProxy;
  }
  _KeyBindingProxy.builtin$cls = "_KeyBindingProxy";
  if (!"name" in _KeyBindingProxy)
    _KeyBindingProxy.name = "_KeyBindingProxy";
  $desc = $collectedClasses._KeyBindingProxy;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _KeyBindingProxy.prototype = $desc;
  function _KeyBindingProxy_keyboardHandler_closure(this_0, handler_1) {
    this.this_0 = this_0;
    this.handler_1 = handler_1;
  }
  _KeyBindingProxy_keyboardHandler_closure.builtin$cls = "_KeyBindingProxy_keyboardHandler_closure";
  if (!"name" in _KeyBindingProxy_keyboardHandler_closure)
    _KeyBindingProxy_keyboardHandler_closure.name = "_KeyBindingProxy_keyboardHandler_closure";
  $desc = $collectedClasses._KeyBindingProxy_keyboardHandler_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _KeyBindingProxy_keyboardHandler_closure.prototype = $desc;
  function _KeyboardHandlerProxy(path, _proxy, _onHasProxy) {
    this.path = path;
    this._proxy = _proxy;
    this._onHasProxy = _onHasProxy;
  }
  _KeyboardHandlerProxy.builtin$cls = "_KeyboardHandlerProxy";
  if (!"name" in _KeyboardHandlerProxy)
    _KeyboardHandlerProxy.name = "_KeyboardHandlerProxy";
  $desc = $collectedClasses._KeyboardHandlerProxy;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _KeyboardHandlerProxy.prototype = $desc;
  function _KeyboardHandlerProxy_closure() {
  }
  _KeyboardHandlerProxy_closure.builtin$cls = "_KeyboardHandlerProxy_closure";
  if (!"name" in _KeyboardHandlerProxy_closure)
    _KeyboardHandlerProxy_closure.name = "_KeyboardHandlerProxy_closure";
  $desc = $collectedClasses._KeyboardHandlerProxy_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _KeyboardHandlerProxy_closure.prototype = $desc;
  ...
  $desc = $collectedClasses._ThemeProxy;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  function createCommandButtons_closure() {
  }
  createCommandButtons_closure.builtin$cls = "createCommandButtons_closure";
  if (!"name" in createCommandButtons_closure)
    createCommandButtons_closure.name = "createCommandButtons_closure";
  $desc = $collectedClasses.createCommandButtons_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  createCommandButtons_closure.prototype = $desc;
  function createCommandButtons_closure0() {
  }
  createCommandButtons_closure0.builtin$cls = "createCommandButtons_closure0";
  if (!"name" in createCommandButtons_closure0)
    createCommandButtons_closure0.name = "createCommandButtons_closure0";
  $desc = $collectedClasses.createCommandButtons_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  createCommandButtons_closure0.prototype = $desc;
  function createCommandButtons_closure1() {
  }
  createCommandButtons_closure1.builtin$cls = "createCommandButtons_closure1";
  if (!"name" in createCommandButtons_closure1)
    createCommandButtons_closure1.name = "createCommandButtons_closure1";
  $desc = $collectedClasses.createCommandButtons_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  createCommandButtons_closure1.prototype = $desc;
  function createCommandButtons_closure2() {
  }
  createCommandButtons_closure2.builtin$cls = "createCommandButtons_closure2";
  if (!"name" in createCommandButtons_closure2)
    createCommandButtons_closure2.name = "createCommandButtons_closure2";
  $desc = $collectedClasses.createCommandButtons_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  createCommandButtons_closure2.prototype = $desc;
  function _createButton_closure(handler_0, name_1) {
    this.handler_0 = handler_0;
    this.name_1 = name_1;
  }
  _createButton_closure.builtin$cls = "_createButton_closure";
  if (!"name" in _createButton_closure)
    _createButton_closure.name = "_createButton_closure";
  $desc = $collectedClasses._createButton_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _createButton_closure.prototype = $desc;
  ...
  function _IdentityHashMap(_length, _strings, _nums, _rest, _keys) {
    this._length = _length;
    this._strings = _strings;
    this._nums = _nums;
    this._rest = _rest;
