...
type theory_state =
  { (* theory definitions: we might have to make the local to a goal to
         support e.g. reduction steps. *)
    ...
    ts_assms   : (string, Assumption.assumption_decision) Ht.t;
    (* FIXME:
