...
val rbad  : bad_version -> gcmd_pos -> Vsym.t -> rule       
val t_bad : bad_version -> gcmd_pos -> Vsym.t -> tactic

val rcheck_hash_args  : ocmd_pos -> rule
val t_check_hash_args : ocmd_pos -> tactic
