...
val getRsym : tenv -> Cpa.Mstring.key -> Rsym.t

val getHsym : tenv -> Cpa.Mstring.key -> Hsym.t

val getPsym : tenv -> Cpa.Mstring.key -> Psym.t
...
val declare_scheme : string -> string -> string -> string -> string -> Cpa.cpaProof